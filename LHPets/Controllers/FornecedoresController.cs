...
namespace LHPets.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cnpj,Ie,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cnpj,Ie,Email")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
